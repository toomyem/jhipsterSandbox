package net.toomyem.jhipster.sandbox.web.rest;

import net.toomyem.jhipster.sandbox.JhipsterSandboxApp;
import net.toomyem.jhipster.sandbox.web.rest.vm.LoggerVM;
